...
export default function FCVFMustang() {
 ...
 <defs>
  ...
  <radialGradient id={`shelbySmoke${_u}`}><stop stopColor="#d4e2e3" stopOpacity=".78"/><stop offset=".48" stopColor="#91a8ad" stopOpacity=".48"/><stop offset="1" stopColor="#a4b1b5" stopOpacity="0"/></radialGradient>
 </defs>
