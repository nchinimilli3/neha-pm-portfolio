...
export default function EsteeCompact(){
 ...
 return <svg ref={scene} className="elCompactArtwork" viewBox="0 -40 520 560" aria-hidden="true" focusable="false">
  <defs>
   <radialGradient id="elClosedGold" cx=".32" cy=".23" r=".95"><stop stopColor="#f3e1b9"/><stop offset=".4" stopColor="#d2b783"/><stop offset=".75" stopColor="#ad8f5a"/><stop offset="1" stopColor="#735832"/></radialGradient>
   <pattern id="elBrushed" width=".03" height=".017" patternUnits="userSpaceOnUse" patternTransform="rotate(12)"><path d="M0 .002H.03M.008 .011H.027" stroke="#fff7df" strokeWidth=".002" opacity=".3"/><path d="M0 .007H.024" stroke="#5a442c" strokeWidth=".001" opacity=".3"/></pattern>
  ...
  <g ref={lid} transform="matrix(168.3 22.1 19 -135 302.2 242.1)">
   ...
   <g ref={lidFace} opacity="0">
    ...
    <ellipse cx="0" cy=".985" rx="1" ry="1" fill="url(#elMetal)"/>
    <ellipse cx="0" cy=".98" rx=".958" ry=".958" fill="url(#elClosedGold)"/>
    <ellipse cx="0" cy=".98" rx=".953" ry=".953" fill="url(#elBrushed)"/>
  ...
  <g transform="translate(-22 -34) rotate(8 324 276)"><rect x="288" y="266" width="69" height="18" rx="5" fill="url(#elMetal)" stroke="#886a42"/><path d="M296 269V281M349 269V281" stroke="#fff0d2" strokeWidth="2"/><path d="M302 268H342" stroke="#fff4de" strokeWidth="2"/></g>
 </svg>
}
