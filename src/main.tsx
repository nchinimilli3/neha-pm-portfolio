...
const toolLogoMap={
  ...
  ucl:{name:'UCL component library',mark:'UCL',urls:[],textOnly:true},
  rally:{name:'Rally',mark:'Rally',urls:[],textOnly:true},
  graphapi:{name:'Graph API validation',mark:'Graph API',urls:[],textOnly:true},
