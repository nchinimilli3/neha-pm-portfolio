...
function BookclubCase(){return <>
  ...
  <CaseSection title="Product walkthrough"><div className="bookclubWalkthrough"><article><figure><img loading="lazy" decoding="async" src={assetUrl('project-media/bookclub/screens/want-to-read.jpg')} alt="Bookclub want-to-read shelf with a prompt to search for or import books"/><figcaption>Live product · shared want-to-read shelf</figcaption></figure><div><span>Choose together</span><h3>Make the next-read decision visible.</h3><p>Members search across book sources, nominate a small set, rank preferences, and resolve ties or runoffs inside the club instead of rebuilding the decision in a group chat.</p></div></article><article><figure><img loading="lazy" decoding="async" src={assetUrl('project-media/bookclub/screens/book-detail.jpg')} alt="Bookclub book-detail page for A Thousand Splendid Suns with discussion context and reading commitment"/><figcaption>Live product · book detail and fit</figcaption></figure><div><span>Decide with enough context</span><h3>Give the group a clearer basis for a yes.</h3><p>Each book page brings together its premise, time commitment, and likely discussion value so members can make a choice that fits the group, not just a title that sounds familiar.</p></div></article><article><figure><img loading="lazy" decoding="async" src={assetUrl('project-media/bookclub/screens/club-activity.jpg')} alt="Bookclub activity view showing member reading progress and recent discussions"/><figcaption>Live product · shared progress and activity</figcaption></figure><div><span>Orient the group</span><h3>Make reading momentum visible.</h3><p>Shared progress and recent activity show how the group is moving through the current title while letting every member keep an honest, individual pace.</p></div></article><article><figure><img loading="lazy" decoding="async" src={assetUrl('project-media/bookclub/screens/reading-plan.jpg')} alt="Bookclub chapter-based reading plan with checkpoints, finish date, and calendar actions"/><figcaption>Live product · reading plan and checkpoints</figcaption></figure><div><span>Read at an honest pace</span><h3>Turn the finish date into manageable checkpoints.</h3><p>Members update by page or chapter. A reading plan creates a shared rhythm and keeps each person’s place visible without forcing everyone to read at the same speed.</p></div></article><article><figure><img loading="lazy" decoding="async" src={assetUrl('project-media/bookclub/screens/meeting-room.jpg')} alt="Bookclub meeting room for A Thousand Splendid Suns showing reader attendance and a start meeting action"/><figcaption>Live product · meeting room</figcaption></figure><div><span>Meet with shared context</span><h3>Bring the book and the group into the same room.</h3><p>The meeting room shows the active title, the readers taking part, and the current stage of the conversation before discussion begins.</p></div></article><article><figure><img loading="lazy" decoding="async" src={assetUrl('project-media/bookclub/screens/meeting-agenda.jpg')} alt="Bookclub meeting room prompt with a reader question and sealed prediction"/><figcaption>Live product · spoiler-aware discussion prompt</figcaption></figure><div><span>Protect the conversation</span><h3>Anchor discussion to reading progress.</h3><p>Thoughts, questions, predictions, quotes, replies, reactions, and agenda items live beside checkpoints, giving the group a spoiler-aware place to remember what mattered before the meeting.</p></div></article><article><figure><img loading="lazy" decoding="async" src={assetUrl('project-media/bookclub/screens/shelves.jpg')} alt="Bookclub shelves showing books currently being read and books already completed"/><figcaption>Live product · current and finished shelves</figcaption></figure><div><span>Close the loop</span><h3>Turn one finished book into the next cycle.</h3><p>Meeting polls, RSVPs, reminders, ratings, and the finished shelf preserve the group’s history and create a clear return path to the next shortlist.</p></div></article></div></CaseSection>
