...
const projects = [
  ...
  },
  {
    ...
    company:'',
    summary:'Most scheduling tools stop at the heatmap. I designed and built a campus scheduling product that preserves uncertainty, recommends the best time, and carries the group into a confirmed place and calendar event.',
    media:'scheduler',
...
function SchedulerCase(){return <div className="schedulerStory">
  ...
  <section className="schedulerProblemStage"><div><h2>Availability wasn’t the whole decision.</h2><p>Students could mark time, but tentative plans were flattened into yes or no. A heatmap still left the group to choose a time, place, and next step elsewhere.</p><blockquote>“We found overlap. Now what?”</blockquote></div><div className="schedulerUncertainty" aria-label="A schedule preserving available, maybe, and unavailable states"><header><strong>Design Sync</strong><span>3 responses</span></header><div className="schedulerMiniGrid"><span></span><b>Tue</b><b>Wed</b><b>Thu</b><span>10:00</span><i className="yes"></i><i className="maybe"></i><i></i><span>10:30</span><i className="best"></i><i className="yes"></i><i className="no"></i><span>11:00</span><i className="maybe"></i><i></i><i className="yes"></i></div><footer><span><i className="yes"></i>Available</span><span><i className="maybe"></i>Maybe</span><span><i className="no"></i>Unavailable</span></footer></div></section>
  <CaseSection title="Seven conversations rewrote the product" className="schedulerResearchSection"><div className="schedulerResearchDesk"><aside className="schedulerInterviewIndex"><strong>7 students</strong><span>One-on-one conversations</span><span>Live task walkthroughs</span><div>{['01','02','03','04','05','06','07'].map(x=><i key={x}>{x}</i>)}</div></aside><div className="schedulerNotebook"><header><strong>Interview synthesis</strong><span>Scheduling a real group project</span></header><div className="schedulerSessionNotes"><article><b>Students hesitated before committing.</b><p>“Maybe” was useful information, but the existing binary grid erased it.</p><span>Seen across availability entry</span></article><article><b>The heatmap did not end the work.</b><p>Groups opened another chat to interpret overlap, choose a room, and confirm the plan.</p><span>Seen after comparing schedules</span></article><article><b>The decision lived in fragments.</b><p>Time, venue, participant status, and notes separated as soon as the group left the grid.</p><span>Seen during follow-through</span></article></div><footer><span>Product decision</span><strong>Preserve uncertainty, then recommend a complete event the group can commit to.</strong></footer></div></div></CaseSection>
  <CaseSection title="One cell becomes the event" className="schedulerDecisionSection"><div className="schedulerDecisionCanvas"><div className="schedulerRecommendationGrid" aria-label="Tuesday 10:30 selected from the group availability grid"><header><span>Group availability</span><strong>3 responses</strong></header><div className="schedulerDecisionDays"><b>Mon</b><b>Tue</b><b>Wed</b></div><div className="schedulerDecisionRows"><span>10:00</span><i></i><i className="warm"></i><i></i><span>10:30</span><i className="warm"></i><i className="chosen">3</i><i className="warm"></i><span>11:00</span><i></i><i className="warm"></i><i></i></div><footer>Highest availability · fewest conflicts</footer></div><div className="schedulerCommitPath" aria-hidden="true"><i></i><span>Choose</span></div><article className="schedulerCalendarInvite"><header><time><b>16</b><span>SEP</span></time><div><span>Tuesday</span><strong>Design Sync</strong></div></header><dl><div><dt>Time</dt><dd>10:30–11:00 AM</dd></div><div><dt>Place</dt><dd>Minskoff Pavilion</dd></div><div><dt>Going</dt><dd><span className="schedulerAvatars"><i>N</i><i>M</i><i>A</i></span>3 participants</dd></div></dl><strong className="schedulerCalendarAction">Calendar ready</strong></article><p className="schedulerDecisionCaption">The recommendation carries the winning time forward with the venue, people, notes, and sharing context intact.</p></div></CaseSection>
  <CaseSection title="One event record stays in sync" className="schedulerSystemSection"><div className="schedulerRecordBlueprint"><article className="schedulerRecordObject"><header><span>Design Sync</span><strong>Event #DS-0916</strong></header><dl><div><dt>Time</dt><dd>Tue · 10:30–11:00</dd><i>live</i></div><div><dt>Participants</dt><dd>Neha · Maya · Alex</dd><i>3/3</i></div><div><dt>Venue</dt><dd>Minskoff Pavilion</dd><i>selected</i></div><div><dt>Group note</dt><dd>Bring the first prototype</dd><i>saved</i></div></dl></article><aside><p><b>Socket.IO</b><span>Keeps active participants and changes synchronized.</span></p><p><b>Flask</b><span>Applies recommendation and event rules.</span></p><p><b>MySQL</b><span>Preserves the shared event record.</span></p></aside><footer>Docker + Google Cloud Run supported the original deployment. The portfolio demo keeps the same interaction model with local browser state.</footer></div></CaseSection>
  <section className="schedulerOutcome"><div className="schedulerOutcomeDate"><span>SEP</span><strong>16</strong><small>TUE</small></div><div className="schedulerOutcomeEvent"><span>10:30–11:00 AM · Minskoff Pavilion</span><strong>Design Sync is on three calendars.</strong><div><i>N</i><i>M</i><i>A</i><b>Everyone leaves with the same plan.</b></div></div><aside><span>Before</span><s>“Does Tuesday morning work?”</s><span>After</span><strong>One confirmed event, ready to join.</strong></aside></section>
</div>}

function ChatCase(){return <div className="chatStory">
  <section className="sandboxSection"><ChatSandbox/></section>
  <section className="chatRuleStage"><div><h2>A message is more than a bubble.</h2><p>The assignment required real-time messages and room presence. I rebuilt iMessage because its familiar surface made the invisible interaction rules worth studying.</p></div><div className="chatMessageSpecimen" aria-label="An iMessage bubble with the states that support it"><span className="chatPresence">Maya joined</span><div className="chatTyping"><i></i><i></i><i></i></div><div className="chatBubble">did everyone push?<b>❤️ 1</b></div><span className="chatDelivery">Delivered to every client</span></div></section>
  <CaseSection title="What persists—and what disappears" className="chatStateSection"><div className="chatStateLedger"><section><h3>Room history keeps</h3><div className="chatPersistLine"><span>Message</span><strong>“did everyone push?”</strong><i>stored + synchronized</i></div><div className="chatPersistLine"><span>Tapback</span><strong>❤️ on the same message</strong><i>updates existing state</i></div></section><section><h3>Live presence releases</h3><div className="chatTransient"><span>typing…</span><i></i><small>times out</small></div><div className="chatTransient"><span>Maya joined</span><i></i><small>room event</small></div></section></div></CaseSection>
  <CaseSection title="The interaction model became the build" className="chatBuildSection"><div className="chatBuildRail"><article><strong>Send</strong><span>Socket.IO broadcasts the message.</span></article><article><strong>Synchronize</strong><span>Every client receives the same room state.</span></article><article><strong>Expire</strong><span>Typing disappears instead of entering history.</span></article><article><strong>Mutate</strong><span>A Tapback updates the original message.</span></article><i aria-hidden="true"></i></div><p>HTML, CSS, JavaScript, and Socket.IO turned those rules into a working product—not just blue and gray styling.</p></CaseSection>
</div>}

function EsteeCase(){return <div className="esteeStory">
  <CaseSection title="The purchase decision starts at the mirror" className="esteeDecisionSection"><div className="esteeVanityDecision"><div className="esteeMirror"><span>Will this finish and shade work for me?</span><i aria-hidden="true"></i></div><div className="esteeBottle" aria-hidden="true"><i></i><b></b></div><article className="esteeConfidenceReceipt"><header>Confidence check</header><p><span>Wear</span><strong>Finish, coverage, performance</strong></p><p><span>Shade</span><strong>Range shown in context</strong></p><p><span>Trust</span><strong>A recognizable brand world</strong></p><p><span>Next step</span><strong>Eight retailer choices</strong></p></article><footer><span>Product decision</span><strong>Organize the experience around shopper confidence, not catalog structure.</strong></footer></div></CaseSection>
  <section className="esteeCounterJourney"><header><span>The digital beauty counter</span><h2>The website works like a beauty counter.</h2><p>Product proof comes first. Shade context follows. Eight retailer options are ready when the shopper decides to continue.</p></header><div className="esteeCounterSurface"><figure className="esteeCounterBenefit"><img loading="lazy" decoding="async" src={assetUrl('project-media/el-benefits.webp')} alt="Double Wear benefits experience"/><figcaption><b>Wear proof</b><span>Understand finish, coverage, and performance.</span></figcaption></figure><div className="esteeSwatchFan" aria-label="A fan of Double Wear shade swatches"><i></i><i></i><i></i><i></i><i></i><i></i></div><figure className="esteeCounterShade"><img loading="lazy" decoding="async" src={assetUrl('project-media/el-shades.webp')} alt="Double Wear shade exploration"/><figcaption><b>Shade range</b><span>See product choice in context.</span></figcaption></figure><figure className="esteeCounterShop"><img loading="lazy" decoding="async" src={assetUrl('project-media/el-shop.webp')} alt="Double Wear retailer purchase page"/><figcaption><b>Eight retailer paths</b><span>Continue to purchase without restarting the search.</span></figcaption></figure></div></section>
  <CaseSection title="The storefront had to hold together on mobile" className="esteeResponsiveSection"><div className="esteeDeviceStage"><div className="esteeDesktopFrame"><header><i></i><i></i><i></i><span>Double Wear discovery</span></header><img loading="lazy" decoding="async" src={assetUrl('project-media/el-home.webp')} alt="Desktop Double Wear homepage"/></div><div className="esteePhoneFrame"><span></span><img loading="lazy" decoding="async" src={assetUrl('project-media/el-shades.webp')} alt="Mobile Double Wear shade page"/></div><aside><strong>Same hierarchy on a smaller canvas.</strong><p>Brand image first, proof second, purchase always reachable.</p></aside></div></CaseSection>
  <section className="esteeScopeReceipt"><header><span>Product scope receipt</span><strong>Double Wear discovery</strong></header><div><span>Keep</span><strong>Brand scale, product imagery, shade context</strong></div><div><span>Simplify</span><strong>Dense catalog details into scannable proof</strong></div><div><span>Partner</span><strong>Send purchase intent to eight established retailers</strong></div><footer>The experience builds confidence. Retail partners complete checkout.</footer></section>
  <section className="esteeOutcome"><div className="esteeOutcomeCopy"><span>Kode With Klossy × Estée Lauder</span><strong>Presented to Estée Lauder C-suite leadership.</strong><p>Selected as a Top 5 challenge finalist with a complete shopper journey from product discovery to retailer choice.</p></div><div className="esteeCompact" aria-label="Top 5 finalist"><i></i><b>Top 5</b><span>Finalist</span></div></section>
</div>}

function BookclubPhoneHero(){return <div className="bookclubPhoneHero" aria-label="Bookclub mobile experience across reading and discussion">
  <figure className="bookclubHeroPhone heroPhoneBack"><img loading="eager" decoding="async" src={assetUrl('project-media/bookclub/mobile/reading-plan.png')} alt="Bookclub reading plan on iPhone"/></figure>
  <figure className="bookclubHeroPhone heroPhoneFront"><img loading="eager" decoding="async" src={assetUrl('project-media/bookclub/mobile/club-home.png')} alt="Bookclub club home on iPhone"/></figure>
  <figure className="bookclubHeroPhone heroPhoneSide"><img loading="eager" decoding="async" src={assetUrl('project-media/bookclub/mobile/conversation-deck.png')} alt="Bookclub conversation deck on iPhone"/></figure>
</div>}
...
function BookclubCase(){return <div className="bookclubStoryV2">
  <section className="bookclubMobileOpening">
    <div className="bookclubOpeningCopy"><h2>The club lives between meetings.</h2><p>Choosing a book, keeping pace, saving thoughts, and getting everyone into the same conversation were scattered across texts, polls, search tabs, and calendars. I designed one private mobile loop to carry the group from the next pick to the next meeting.</p><blockquote>Not another feed. A shared reading rhythm.</blockquote></div>
    <div className="bookclubOpeningPhones"><figure><img loading="lazy" decoding="async" src={assetUrl('project-media/bookclub/mobile/club-home.png')} alt="College Friends Bookclub home on iPhone"/></figure><figure><img loading="lazy" decoding="async" src={assetUrl('project-media/bookclub/mobile/book-detail.png')} alt="A Thousand Splendid Suns book detail on iPhone"/></figure></div>
  </section>

  <section className="bookclubLoopRibbon" aria-label="Bookclub product loop"><span>Choose together</span><i></i><span>Read at your pace</span><i></i><span>Meet with something to say</span><i></i><strong>Repeat</strong></section>

  <section className="bookclubReadingChapter">
    <div className="bookclubChapterPhones"><figure className="bookclubPlanPhone"><img loading="lazy" decoding="async" src={assetUrl('project-media/bookclub/mobile/reading-plan.png')} alt="Bookclub reading plan and discussion checkpoints on iPhone"/></figure><figure className="bookclubProgressPhone"><img loading="lazy" decoding="async" src={assetUrl('project-media/bookclub/mobile/update-progress.png')} alt="Bookclub reading progress update on iPhone"/></figure></div>
    <div className="bookclubChapterCopy"><span>Different editions. Different speeds.</span><h2>Progress protects the conversation.</h2><p>Chapter or page tracking keeps the signal lightweight while checkpoints give every post spoiler context. Readers stay connected without pretending they move through the book together.</p><dl><div><dt>Decision</dt><dd>Support page and chapter progress.</dd></div><div><dt>Tradeoff</dt><dd>Useful orientation over false precision.</dd></div><div><dt>Outcome</dt><dd>Readers know what is safe to open.</dd></div></dl></div>
  </section>

  <section className="bookclubMeetingChapter">
    <div className="bookclubMeetingCopy"><h2>Saved thoughts become the agenda.</h2><p>Questions, passages, predictions, and reading checkpoints should not disappear into a thread. The meeting room carries that context into one focused conversation.</p><div className="bookclubMeetingSignal"><strong>Reading thought</strong><i></i><strong>Discussion prompt</strong><i></i><strong>Meeting moment</strong></div></div>
    <div className="bookclubMeetingPhones"><figure><img loading="lazy" decoding="async" src={assetUrl('project-media/bookclub/mobile/meeting-room.png')} alt="Bookclub meeting room on iPhone"/></figure><figure><img loading="lazy" decoding="async" src={assetUrl('project-media/bookclub/mobile/conversation-deck.png')} alt="Bookclub spoiler-safe conversation prompt on iPhone"/></figure></div>
  </section>

  <CaseSection title="The product decisions" className="bookclubDecisionShelf"><div className="bookclubDecisionManuscript"><article><b>Private by default</b><p>Invite-only clubs protect the intimacy of an existing group.</p><small>Member-led growth, not a public feed.</small></article><article><b>Preference over popularity</b><p>Ranked choices and runoff handling find an acceptable group pick.</p><small>A few more taps for a fairer decision.</small></article><article><b>AI assists; members decide</b><p>Discovery and reading context can be assisted. Nominations, rankings, and shared posts remain human choices.</p><small>Assistance stays bounded and reviewable.</small></article><article><b>Calendar as a handoff</b><p>Polls and reminders finish the plan without rebuilding a calendar.</p><small>External calendars own the final event.</small></article></div></CaseSection>

  <section className="bookclubLiveProof"><div><strong>Live and in active testing</strong><span>Roughly 15 friends</span><p>I’m watching where first-use, selection, reading rhythm, and conversation carryover still create friction.</p></div><div className="bookclubTestPulse" aria-hidden="true">{Array.from({length:8},(_,index)=><i key={index}></i>)}</div></section>
</div>}
