...
function EsteeCase(){return <div className="esteeStory">
  <section className="esteeEditorialOpening"><figure><img loading="lazy" decoding="async" src={assetUrl('project-media/el-home.webp')} alt="Estée Lauder Double Wear landing experience"/></figure><div><h2>Turn attraction into product confidence.</h2><p>Online beauty shoppers needed enough context to decide whether Double Wear fit their needs, then a direct path to purchase. I treated the experience as guided discovery—not a static storefront.</p><span>Concept · UX/UI · frontend</span></div></section>
  <CaseSection title="The shopper’s decision" className="esteeDecisionSection"><div className="esteeDecisionSpread"><div className="esteeBottle" aria-hidden="true"><i></i><b></b></div><blockquote>Will this foundation work for me?</blockquote><dl><div><dt>Proof</dt><dd>Benefits and wear information</dd></div><div><dt>Fit</dt><dd>Shade and product exploration</dd></div><div><dt>Trust</dt><dd>A visual system that feels recognizably Estée Lauder</dd></div><div><dt>Action</dt><dd>Eight retailer paths without restarting the search</dd></div></dl></div></CaseSection>
  <section className="esteeConfidenceSpread"><figure className="esteeBenefitImage"><img loading="lazy" decoding="async" src={assetUrl('project-media/el-benefits.webp')} alt="Double Wear benefits experience"/><figcaption>Explain the value</figcaption></figure><div className="esteeSwatches" aria-label="Foundation shade swatches"><i></i><i></i><i></i><i></i><i></i><strong>Make exploration feel tactile.</strong></div><figure className="esteeShadeImage"><img loading="lazy" decoding="async" src={assetUrl('project-media/el-shades.webp')} alt="Double Wear shade exploration"/><figcaption>Build confidence</figcaption></figure><div className="esteeEditorialCopy"><h2>One editorial rhythm across every screen.</h2><p>Large imagery drew shoppers in. Concise benefit content made the product scannable. Shade exploration and retailer links turned attention into a next step.</p></div><figure className="esteeShopImage"><img loading="lazy" decoding="async" src={assetUrl('project-media/el-shop.webp')} alt="Double Wear retailer purchase page"/><figcaption>Close the loop</figcaption></figure></section>
  <CaseSection title="Designed to survive the small screen" className="esteeResponsiveSection"><div className="esteeResponsiveProof"><strong>Editorial scale</strong><i></i><span>Flexible image crops</span><i></i><span>Readable product proof</span><i></i><strong>Clear purchase action</strong></div><p>The image-heavy concept was rebuilt responsively so the story, hierarchy, and purchase path stayed coherent as the viewport narrowed.</p></CaseSection>
  <section className="esteeOutcome"><strong>Top 5 finalist</strong><span>Presented to Estée Lauder C-suite leadership</span></section>
</div>}
