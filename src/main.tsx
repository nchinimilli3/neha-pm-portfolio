...
function EsteeCase(){
 ...
 return <div className="elEditorial">
  {/* Problem / real campaign / browsing becomes a personal question / static reflection. */}
  <section className="elVanity">
   ...
   <div className="elProblem"><span className="elIndex">01 / The shopper problem</span><h2>A beautiful product.<br/> A personal decision.</h2><p>Online, shoppers cannot try a tester at the counter. They need to understand the finish, coverage, and shade context before deciding where to buy.</p><p>I organized discovery around that decision: introduce the product, make its benefits easy to explore, then offer a clear next step.</p><div className="elNote"><b>My starting insight</b><p>Double Wear already had strong campaign imagery and product information. The opportunity was to bring those materials into one guided experience.</p></div></div>
  </section>
  {/* Evidence / original question screen / passive campaign becomes invitation / no added motion. */}
  <section className="elInvitation"><header><span className="elIndex">02 / Invite exploration</span><h2>Start with what<br/> the shopper cares about.</h2><p>I used an interactive question to make product discovery active, while keeping the familiar Estée Lauder brand world.</p></header><figure><img src={assetUrl('project-media/el-shop.webp')} alt="Original Double Wear screen asking what the shopper looks for in a foundation" loading="lazy"/><figcaption>The original question screen. Product imagery creates recognition; the question gives the shopper a way in.</figcaption></figure></section>
  {/* Decision / real benefits carousel / dense information becomes scannable proof. */}
  <section className="elProof"><header><span className="elIndex">03 / Build product understanding</span><h2>Let the product<br/> <em>make its case.</em></h2><p>I brought finish, coverage, and wear into a benefits carousel. Each view gives one product idea room to register, instead of asking shoppers to parse a wall of detail.</p></header><figure><img src={assetUrl('project-media/el-benefits.webp')} alt="Original benefits carousel showing finish, buildable coverage, and wear information" loading="lazy"/><figcaption>Actual project screen · Product benefits carousel</figcaption></figure></section>
  {/* Tradeoff / explicitly editorial receipt and real retailer screen / discovery hands off to checkout. */}
  <section className="elPurchase"><div className="elRetail"><span className="elIndex">04 / Make the next step clear</span><h2>A place to explore.<br/> Eight places to buy.</h2><p>I connected purchase intent to eight established retailers. This kept the concept focused on discovery and product education, with checkout handled by retail partners.</p><figure><img src={assetUrl('project-media/el-shades.webp')} alt="Original purchase page showing foundation imagery and retailer links including Estée Lauder, Sephora, Ulta, and Nordstrom" loading="lazy"/><figcaption>Original retailer page, with product and shade context.</figcaption></figure></div><aside className="elReceipt"><div className="elReceiptBrand">Estée Lauder<br/> <small>Double Wear discovery</small></div><h3>The product tradeoff</h3><p className="elReceiptSub">A summary of my scope decisions</p><dl><div><dt>Keep</dt><dd>Brand scale, product imagery, and shade context.</dd></div><div><dt>Simplify</dt><dd>Dense product details into scannable proof.</dd></div><div><dt>Partner</dt><dd>Send purchase intent to eight established retailers.</dd></div></dl><div className="elReceiptTotal"><span>Scope</span><b>Discovery → retailer</b></div><p>The tradeoff: a cohesive discovery experience, followed by a handoff to another site for checkout.</p><div className="elBarcode" aria-hidden="true"/><small>Case-study summary · not a purchase receipt</small></aside></section>
