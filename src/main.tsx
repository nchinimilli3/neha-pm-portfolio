...
function BookclubCase(){return <>
  ...
  <CaseSection title="System design"><p className="bookclubSystemIntro">One server layer keeps private club data controlled while book, calendar, OCR, and AI services stay replaceable.</p><div className="bookclubArchitecture" aria-label="Bookclub system architecture"><article><span>Experience</span><strong>React · TypeScript · Vite</strong><small>Responsive product UI on Cloudflare Pages</small></article><b aria-hidden="true">→</b><article className="bookclubArchitectureCore"><span>Product services</span><strong>Cloudflare Workers</strong><div><small>Club workflows</small><small>AI + OCR</small><small>Calendar + reminders</small></div></article><b aria-hidden="true">→</b><article><span>Private data</span><strong>D1 · R2</strong><small>Relational club state · product media</small></article></div><div className="bookclubServiceRail"><span><b>Discovery</b> NYT · Google Books · Open Library</span><span><b>Assistance</b> OpenAI · Google Vision OCR</span><span><b>Coordination</b> Google Calendar</span></div></CaseSection>
