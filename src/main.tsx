...
function AccentureCase(){return <div className="accentureStory">
  ...
  <CaseSection title="Where the process broke" className="accentureProblem"><div><p className="accentureLeadCopy">The work got done, but the system depended on coordinator judgment living in people’s heads. Every inconsistent request created more interpretation, more matching risk, and a more fragile handoff.</p><div className="accentureBottleneck"><div className="accentureRequestPile"><span>INCOMING REQUESTS</span><article><b>TOPIC</b><i>different shape</i></article><article><b>REGION</b><i>sometimes missing</i></article><article><b>TIMING</b><i>often ambiguous</i></article></div><div className="accentureJudgment"><span>THE BOTTLENECK</span><strong>Coordinator<br/>judgment</strong><div aria-hidden="true"><i></i><i></i><i></i></div><small>Critical rules were remembered, not encoded.</small></div><div className="accentureFailureStack"><article><b>01</b><strong>Inconsistent intake</strong><span>Key details arrived in different forms.</span></article><article><b>02</b><strong>Multi-constraint match</strong><span>Expertise alone was not enough.</span></article><article><b>03</b><strong>Fragile handoff</strong><span>Every missing assumption traveled downstream.</span></article></div></div></div></CaseSection>

  <CaseSection title="People and handoffs" className="accenturePeople"><div><div className="accenturePeopleFlow" aria-label="Stakeholder handoff from request to learning"><article><header><span>01</span><small>INITIATES</small></header><h3>Requester</h3><p>Defines the enablement need, scope, and timing.</p><b>REQUEST</b></article><i aria-hidden="true">→</i><article><header><span>02</span><small>TRANSLATES</small></header><h3>Coordinator</h3><p>Turns ambiguity into a workable plan.</p><b>PLAN</b></article><i aria-hidden="true">→</i><article><header><span>03</span><small>DELIVERS</small></header><h3>Trainer</h3><p>Needs a realistic match across expertise, language, availability, and local hours.</p><b>SESSION</b></article><i aria-hidden="true">→</i><article><header><span>04</span><small>EXPERIENCES</small></header><h3>Learner / customer</h3><p>Needs value that continues after the session.</p><b>OUTCOME</b></article></div><div className="accentureSharedPacket"><span>ONE REQUEST PACKET</span><strong>The object stays coherent while ownership changes.</strong><i aria-hidden="true"></i></div></div></CaseSection>
