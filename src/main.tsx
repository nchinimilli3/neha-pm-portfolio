...
function KohlerCase(){
 ...
 return <div className="kohlerStory">
  ...
  <CaseSection title="Where each decision comes from" className="kohlerArchitectureSection"><div><div className="kohlerArchitectureWrap"><div className="kohlerArchitecture" aria-label="Approved enterprise sources flow through a three-part Azure document workflow into human-reviewable outputs"><div className="kohlerSourceStack"><h3>Approved inputs</h3><article><img src={assetUrl('tool-logos/sap.svg')} alt=""/><div><strong>SAP ECC</strong><small>Order · SKU · destination</small></div></article><article><img src={assetUrl('tool-logos/inriver.webp')} alt=""/><div><strong>Inriver PIM</strong><small>Approved product attributes</small></div></article><article><b>LBL</b><div><strong>Labelling systems</strong><small>Market marks · packaging rules</small></div></article></div><div className="kohlerDataCurrent" aria-hidden="true"><i></i><i></i><i></i></div><div className="kohlerAzureCore"><h3>Document workflow</h3><p>Azure services retrieve, assemble, and present the work.</p><div className="kohlerAzureSteps"><article><img src={assetUrl('tool-logos/databricks.svg')} alt=""/><div><strong>Retrieve trusted data</strong><small>Databricks prepares enterprise context.</small></div></article><article><img src={assetUrl('tool-logos/azure-ai-foundry.svg')} alt=""/><div><strong>Compose and check</strong><small>AI Foundry assembles the regional document.</small></div></article><article><img src={assetUrl('tool-logos/copilot-studio.svg')} alt=""/><div><strong>Guide review</strong><small>Copilot Studio presents gaps and approvals.</small></div></article></div></div><div className="kohlerOutputBranch"><h3>Reviewable results</h3><article><strong>Regional document</strong><small>Source-linked · versioned</small></article><article><strong>Exception list</strong><small>Missing and conflicting evidence</small></article><article><strong>Audit record</strong><small>Inputs · reviewer · timestamp</small></article></div></div></div><div className="kohlerFailureModes">{[
   ['Missing product fact','Send it to the product-data owner.'],['Conflicting regional source','Show both sources for a reviewer to resolve.'],['Incomplete evidence','Block approval and record what is missing.']
  ].map(([signal,response])=><article key={signal}><strong>{signal}</strong><p>{response}</p></article>)}</div></div></CaseSection>
