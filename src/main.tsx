...
const projects = [
  ...
  },
  {
    ...
    company:'',
    summary:'Built on When2Meet’s fast availability grid, then added uncertainty, recommendations, venue coordination, and real-time collaboration around it.',
    media:'scheduler',
...
const experienceItems=[
 ...
 {id:'spectrum',company:'Spectrum Consulting Group',role:'Consultant · Client Acquisition Lead',location:'East Lansing, MI',dates:'2022–2026',logo:'company-logos/spectrum-v31.png',short:'Led and delivered client strategy across hospitality, utilities, automotive, food-business, and PE/BS&A engagements.',detail:<div className="expStory"><div className="expMetricRow"><span><b>3,000+</b> survey responses</span><span><b>19</b> utility KPIs</span><span><b>$15K</b> automotive workstream</span><span><b>2</b> analysts mentored</span></div><div className="expColumns"><div><strong>Hospitality</strong><span>Found engagement gaps across 3,000+ responses and recommended three digital initiatives that increased social interaction by 20%.</span></div><div><strong>Utilities</strong><span>Built a criticality/feasibility rubric, defined 19 KPIs, and evaluated three software options for a multimillion-dollar utility.</span></div><div><strong>Automotive</strong><span>Led the analysis workstream, translated pain points and funnel evidence into implementation-ready recommendations, and redesigned lead-management workflows.</span></div></div><div className="expNote">Additional engagements included a food-business strategy project and BS&amp;A work with a private-equity firm.</div></div>},
 ...
 {id:'palmer',company:'Russell Palmer Career Management Center',role:'Peer Coach',location:'East Lansing, MI',dates:'May 2025–present',logo:'company-logos/palmer-v31.png',short:'Coach students through recruiting decisions one conversation at a time.',detail:<div className="expStory"><p>I diagnose what is actually blocking a student—positioning, resume evidence, interview structure, networking, or case prep—and turn it into a concrete next step.</p><div className="expMetricRow"><span><b>20+</b> sessions weekly</span><span><b>300+</b> students coached</span><span><b>25</b> coaches on team</span><span><b>~40%</b> of positive feedback in one 800-appointment snapshot</span></div></div>}
];
...
function Home({openCase}){
 ...
 <main id="main-content">
  ...
  <section id="about" className="section aboutSection"><div className="aboutPhoto"><img src="headshot.jpg" alt="Neha Chinimilli" width={1066} height={1599}/></div><div className="aboutCopy"><h2>About me</h2><p>I’m Neha. I study Computer Science and Supply Chain Management at Michigan State, which means I spend a lot of time bouncing between how systems work and how people actually use them.</p><p>I like building things that make an annoying process a little easier—whether that’s a product at work, a class project, or something I made because I got tired of doing the same thing manually.</p><details className="outsideWork"><summary>Outside of work <span aria-hidden="true">+</span></summary><div><p><strong>Film photography.</strong> I shoot city scenes, landscapes, and little details I probably would have walked past otherwise.</p><p><strong>Exploring cities.</strong> A lot of my camera roll is neighborhoods, transit, restaurants, and places I found by walking until something looked interesting.</p><p><strong>Usually trying something new.</strong> A new food spot, a ski trip, a roll of film, or a small tool I wish already existed.</p></div></details></div></section>
