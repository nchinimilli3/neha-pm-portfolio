...
function AccentureCase(){return <div className="accentureStory">
  ...
  <CaseSection title="People in the system" className="accenturePeople"><div className="factGrid accentureUserGrid"><Fact title="Requester">Needs the right enablement, with the right scope and timing.</Fact><Fact title="Coordinator">Turns an ambiguous request into a deliverable plan.</Fact><Fact title="Trainer">Needs an assignment that matches expertise, language, availability, and local working hours.</Fact><Fact title="Learner / Enterprise Customer">Needs training that is useful after the session ends.</Fact></div></CaseSection>
